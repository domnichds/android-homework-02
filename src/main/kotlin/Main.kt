...
class Book(id : Int, name : String, accessible: Boolean, private var numberOfPages : Int, private var author : String) : LibraryItem(id, name, accessible)
{
    override fun getInfo() : String =
        "Книга: $name ($numberOfPages стр.) автора: $author с id: $id | Доступность: ${if (accessible) "да" else "нет"}"
}

class Newspaper(id : Int, name : String, accessible: Boolean, private var issueNumber : Int) : LibraryItem(id, name, accessible)
{
    override fun getInfo() : String =
